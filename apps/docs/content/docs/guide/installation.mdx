...
<PackageManagers
  commands={{
    npm: "npm install -g vezham-cli",
    yarn: "yarn global add vezham-cli",
    pnpm: "pnpm add -g vezham-cli",
    bun: "bun add -g vezham-cli",
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @vx-oss/heroui-v2-react framer-motion",
...
<PackageManagers
  commands={{
    npm: "npm install @vx-oss/heroui-v2-theme @vx-oss/heroui-v2-system framer-motion",
    yarn: "yarn add @vx-oss/heroui-v2-theme @vx-oss/heroui-v2-system framer-motion",
    pnpm: "pnpm add @vx-oss/heroui-v2-theme @vx-oss/heroui-v2-system framer-motion",
    bun: "bun add @vx-oss/heroui-v2-theme @vx-oss/heroui-v2-system framer-motion"
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @vx-oss/heroui-v2-button",
    yarn: "yarn add @vx-oss/heroui-v2-button",
    pnpm: "pnpm add @vx-oss/heroui-v2-button",
    bun: "bun add @vx-oss/heroui-v2-button"
  }}
/>
...
```js
// tailwind.config.js
const {heroui} = require("@vx-oss/heroui-v2-theme");

/** @type {import('tailwindcss').Config} */
module.exports = {
  content: [
    // single component styles
    "./node_modules/@vx-oss/heroui-v2-theme/dist/components/button.js",
    // or you can use a glob pattern (multiple component styles)
    './node_modules/@vx-oss/heroui-v2-theme/dist/components/(button|snippet|code|input).js'
  ],
  theme: {
    extend: {},
  },
