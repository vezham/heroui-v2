...
- [Node.js version 20.19.x or later](https://nodejs.org/en/)
...
<PackageManagers
  commands={{
    npm: "npx vezham-cli@latest",
    yarn: "yarn dlx vezham-cli@latest",
    pnpm: "pnpm dlx vezham-cli@latest",
    bun: "bunx vezham-cli@latest",
  }}
/>
...
Required min version: @vx-oss/heroui-v2-theme>=2.1.0, tailwindcss>=3.4.0
╭───────────────────── PeerDependencies ─────────────────────╮
...
│   Package                    │   Version              │   Status    │   Docs                                              │
│───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────│
│   @vx-oss/heroui-v2-autocomplete   │   2.0.10 🚀latest      │   newPost   │   https://v2.heroui.com/docs/components/autocomplete   │
...
For updates and source code, visit the [GitHub Repository](https://github.com/vezham/heroui-v2-cli).
