...
<PackageManagers
  commands={{
    npm: "npx @vx-oss/heroui-v2-codemod@latest migrate",
    pnpm: "pnpm dlx @vx-oss/heroui-v2-codemod@latest migrate",
    yarn: "yarn dlx @vx-oss/heroui-v2-codemod@latest migrate",
    bun: "bunx --bun @vx-oss/heroui-v2-codemod@latest migrate"
  }}
/>
...
- Update all package names from `@nextui-org/*` to `@vx-oss/heroui-v2-*`
...
<PackageManagers
  commands={{
    npm: "npm uninstall @nextui-org/react && npm install @vx-oss/heroui-v2-react",
    yarn: "yarn remove @nextui-org/react && yarn add @vx-oss/heroui-v2-react",
    pnpm: "pnpm remove @nextui-org/react && pnpm add @vx-oss/heroui-v2-react",
    bun: "bun remove @nextui-org/react && bun add @vx-oss/heroui-v2-react"
  }}
/>
...
// After
import {Button, Input} from "@vx-oss/heroui-v2-react";
```
...
If you encounter any issues during migration, please [open an issue](https://github.com/vezham/heroui-v2/issues) on our GitHub repository.
