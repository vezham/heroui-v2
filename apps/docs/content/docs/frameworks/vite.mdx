...
<PackageManagers
  commands={{
    npm: 'npx vezham-cli@latest init -t vite',
    yarn: 'yarn dlx vezham-cli@latest init -t vite',
    pnpm: 'pnpm dlx vezham-cli@latest init -t vite',
    bun: "bunx vezham-cli@latest init -t vite"
  }}
/>
