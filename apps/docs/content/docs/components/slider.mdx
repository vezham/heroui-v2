...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add slider",
    npm: "npm install @vx-oss/heroui-v2-slider",
    yarn: "yarn add @vx-oss/heroui-v2-slider",
    pnpm: "pnpm add @vx-oss/heroui-v2-slider",
    bun: "bun add @vx-oss/heroui-v2-slider"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Slider} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Slider} from "@vx-oss/heroui-v2-slider";',
  }}
/>
