...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add date-input",
    npm: "npm install @vx-oss/heroui-v2-date-input",
    yarn: "yarn add @vx-oss/heroui-v2-date-input",
    pnpm: "pnpm add @vx-oss/heroui-v2-date-input",
    bun: "bun add @vx-oss/heroui-v2-date-input",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {DateInput} from "@vx-oss/heroui-v2-react";',
    individual: 'import {DateInput} from "@vx-oss/heroui-v2-date-input";',
  }}
/>
