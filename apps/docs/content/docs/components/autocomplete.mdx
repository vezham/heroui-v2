...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add autocomplete",
    npm: "npm install @vx-oss/heroui-v2-autocomplete",
    yarn: "yarn add @vx-oss/heroui-v2-autocomplete",
    pnpm: "pnpm add @vx-oss/heroui-v2-autocomplete",
    bun: "bun add @vx-oss/heroui-v2-autocomplete",
  }}
/>
...
<ImportTabs
  ...
  AutocompleteSection,
  AutocompleteItem
} from "@vx-oss/heroui-v2-autocomplete";`,
  }}
/>
