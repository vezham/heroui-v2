...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add badge",
    npm: "npm install @vx-oss/heroui-v2-badge",
    yarn: "yarn add @vx-oss/heroui-v2-badge",
    pnpm: "pnpm add @vx-oss/heroui-v2-badge",
    bun: "bun add @vx-oss/heroui-v2-badge"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Badge} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Badge} from "@vx-oss/heroui-v2-badge";',
  }}
/>
