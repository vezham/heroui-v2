...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add avatar",
    npm: "npm install @vx-oss/heroui-v2-avatar",
    yarn: "yarn add @vx-oss/heroui-v2-avatar",
    pnpm: "pnpm add @vx-oss/heroui-v2-avatar",
    bun: "bun add @vx-oss/heroui-v2-avatar"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Avatar, AvatarGroup, AvatarIcon} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Avatar, AvatarGroup, AvatarIcon} from "@vx-oss/heroui-v2-avatar";',
  }}
/>
