...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add drawer",
    npm: "npm install @vx-oss/heroui-v2-drawer",
    yarn: "yarn add @vx-oss/heroui-v2-drawer",
    pnpm: "pnpm add @vx-oss/heroui-v2-drawer",
    bun: "bun add @vx-oss/heroui-v2-drawer"
  }}
/>
