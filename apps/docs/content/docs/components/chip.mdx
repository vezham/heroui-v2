...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add chip",
    npm: "npm install @vx-oss/heroui-v2-chip",
    yarn: "yarn add @vx-oss/heroui-v2-chip",
    pnpm: "pnpm add @vx-oss/heroui-v2-chip",
    bun: "bun add @vx-oss/heroui-v2-chip"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Chip} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Chip} from "@vx-oss/heroui-v2-chip";',
  }}
/>
