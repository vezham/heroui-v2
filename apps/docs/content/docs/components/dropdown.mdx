...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add dropdown",
    npm: "npm install @vx-oss/heroui-v2-dropdown",
    yarn: "yarn add @vx-oss/heroui-v2-dropdown",
    pnpm: "pnpm add @vx-oss/heroui-v2-dropdown",
    bun: "bun add @vx-oss/heroui-v2-dropdown"
  }}
/>
...
<ImportTabs
  commands={{
    ...
    DropdownSection,
    DropdownItem
} from "@vx-oss/heroui-v2-dropdown";`,
  }}
/>
...
```jsx
import {Dropdown, DropdownMenu, DropdownTrigger, DropdownItem, Button} from "@vx-oss/heroui-v2-react";
