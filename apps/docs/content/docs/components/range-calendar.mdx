...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add calendar",
    npm: "npm install @vx-oss/heroui-v2-calendar",
    yarn: "yarn add @vx-oss/heroui-v2-calendar",
    pnpm: "pnpm add @vx-oss/heroui-v2-calendar",
    bun: "bun add @vx-oss/heroui-v2-calendar",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {RangeCalendar} from "@vx-oss/heroui-v2-react";',
    individual: 'import {RangeCalendar} from "@vx-oss/heroui-v2-calendar";',
  }}
/>
