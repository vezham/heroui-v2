...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add table",
    npm: "npm install @vx-oss/heroui-v2-table",
    yarn: "yarn add @vx-oss/heroui-v2-table",
    pnpm: "pnpm add @vx-oss/heroui-v2-table",
    bun: "bun add @vx-oss/heroui-v2-table"
  }}
/>
...
```jsx
import {Table, TableHeader, TableColumn, TableBody, TableRow, TableCell, getKeyValue} from "@vx-oss/heroui-v2-react";
...
[@vx-oss/heroui-v2-use-infinite-scroll](https://www.npmjs.com/package/@vx-oss/heroui-v2-use-infinite-scroll) hook.

<PackageManagers
  commands={{
    npm: "npm install @react-stately/data @vx-oss/heroui-v2-use-infinite-scroll",
    yarn: "yarn add @react-stately/data @vx-oss/heroui-v2-use-infinite-scroll",
    pnpm: "pnpm add @react-stately/data @vx-oss/heroui-v2-use-infinite-scroll",
    bun: "bun add @react-stately/data @vx-oss/heroui-v2-use-infinite-scroll",
  }}
/>
