...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add switch",
    npm: "npm install @vx-oss/heroui-v2-switch",
    yarn: "yarn add @vx-oss/heroui-v2-switch",
    pnpm: "pnpm add @vx-oss/heroui-v2-switch",
    bun: "bun add @vx-oss/heroui-v2-switch"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Switch} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Switch} from "@vx-oss/heroui-v2-switch";',
  }}
/>
