...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add card",
    npm: "npm install @vx-oss/heroui-v2-card",
    yarn: "yarn add @vx-oss/heroui-v2-card",
    pnpm: "pnpm add @vx-oss/heroui-v2-card",
    bun: "bun add @vx-oss/heroui-v2-card"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Card, CardHeader, CardBody, CardFooter} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Card, CardHeader, CardBody, CardFooter} from "@vx-oss/heroui-v2-card";',
  }}
/>
