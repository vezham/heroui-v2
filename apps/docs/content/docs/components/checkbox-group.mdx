...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add checkbox",
    npm: "npm install @vx-oss/heroui-v2-checkbox",
    yarn: "yarn add @vx-oss/heroui-v2-checkbox",
    pnpm: "pnpm add @vx-oss/heroui-v2-checkbox",
    bun: "bun add @vx-oss/heroui-v2-checkbox"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {CheckboxGroup, Checkbox} from "@vx-oss/heroui-v2-react";',
    individual: 'import {CheckboxGroup, Checkbox} from "@vx-oss/heroui-v2-checkbox";',
  }}
/>
