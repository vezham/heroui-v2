...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add alert",
    npm: "npm install @vx-oss/heroui-v2-alert",
    yarn: "yarn add @vx-oss/heroui-v2-alert",
    pnpm: "pnpm add @vx-oss/heroui-v2-alert",
    bun: "bun add @vx-oss/heroui-v2-alert",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Alert} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Alert} from "@vx-oss/heroui-v2-alert";',
  }}
/>
