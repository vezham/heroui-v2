...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add modal",
    npm: "npm install @vx-oss/heroui-v2-modal",
    yarn: "yarn add @vx-oss/heroui-v2-modal",
    pnpm: "pnpm add @vx-oss/heroui-v2-modal",
    bun: "bun add @vx-oss/heroui-v2-modal"
  }}
/>
