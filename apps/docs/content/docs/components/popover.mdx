...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add popover",
    npm: "npm install @vx-oss/heroui-v2-popover",
    yarn: "yarn add @vx-oss/heroui-v2-popover",
    pnpm: "pnpm add @vx-oss/heroui-v2-popover",
    bun: "bun add @vx-oss/heroui-v2-popover"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Popover, PopoverTrigger, PopoverContent} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Popover, PopoverTrigger, PopoverContent} from "@vx-oss/heroui-v2-popover";',
  }}
/>
