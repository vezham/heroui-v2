...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add scroll-shadow",
    npm: "npm install @vx-oss/heroui-v2-scroll-shadow",
    yarn: "yarn add @vx-oss/heroui-v2-scroll-shadow",
    pnpm: "pnpm add @vx-oss/heroui-v2-scroll-shadow",
    bun: "bun add @vx-oss/heroui-v2-scroll-shadow"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {ScrollShadow} from "@vx-oss/heroui-v2-react";',
    individual: 'import {ScrollShadow} from "@vx-oss/heroui-v2-scroll-shadow";',
  }}
/>
