...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add button",
...
<ImportTabs
  commands={{
    main: 'import {Button, ButtonGroup} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Button, ButtonGroup} from "@vx-oss/heroui-v2-button";',
  }}
/>
