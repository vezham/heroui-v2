...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add select",
    npm: "npm install @vx-oss/heroui-v2-select",
    yarn: "yarn add @vx-oss/heroui-v2-select",
    pnpm: "pnpm add @vx-oss/heroui-v2-select",
    bun: "bun add @vx-oss/heroui-v2-select"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Select, SelectSection, SelectItem} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Select, SelectSection, SelectItem} from "@vx-oss/heroui-v2-select";',
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @vx-oss/heroui-v2-use-infinite-scroll",
    yarn: "yarn add @vx-oss/heroui-v2-use-infinite-scroll",
    pnpm: "pnpm add @vx-oss/heroui-v2-use-infinite-scroll",
  }}
/>
