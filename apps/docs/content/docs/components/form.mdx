...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add form",
    npm: "npm install @vx-oss/heroui-v2-form",
    yarn: "yarn add @vx-oss/heroui-v2-form",
    pnpm: "pnpm add @vx-oss/heroui-v2-form",
    bun: "bun add @vx-oss/heroui-v2-form",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Form} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Form} from "@vx-oss/heroui-v2-form";',
  }}
/>
...
```tsx
import {Form, Button} from '@vx-oss/heroui-v2-react';
