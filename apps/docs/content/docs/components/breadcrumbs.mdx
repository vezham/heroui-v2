...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add breadcrumbs",
    npm: "npm install @vx-oss/heroui-v2-breadcrumbs",
    yarn: "yarn add @vx-oss/heroui-v2-breadcrumbs",
    pnpm: "pnpm add @vx-oss/heroui-v2-breadcrumbs",
    bun: "bun add @vx-oss/heroui-v2-breadcrumbs"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Breadcrumbs, BreadcrumbItem} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Breadcrumbs, BreadcrumbItem} from "@vx-oss/heroui-v2-breadcrumbs";',
  }}
/>
