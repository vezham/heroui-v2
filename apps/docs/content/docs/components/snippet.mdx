...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add snippet",
    npm: "npm install @vx-oss/heroui-v2-snippet",
    yarn: "yarn add @vx-oss/heroui-v2-snippet",
    pnpm: "pnpm add @vx-oss/heroui-v2-snippet",
    bun: "bun add @vx-oss/heroui-v2-snippet"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Snippet} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Snippet} from "@vx-oss/heroui-v2-snippet";',
  }}
/>
