...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add input-otp",
    npm: "npm install @vx-oss/heroui-v2-input-otp",
    yarn: "yarn add @vx-oss/heroui-v2-input-otp",
    pnpm: "pnpm add @vx-oss/heroui-v2-input-otp",
    bun: "bun add @vx-oss/heroui-v2-input-otp",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {InputOtp} from "@vx-oss/heroui-v2-react";',
    individual: 'import {InputOtp} from "@vx-oss/heroui-v2-input-otp";',
  }}
/>
