...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/heroui-v2-code",
    yarn: "yarn add @vx-oss/heroui-v2-code",
    pnpm: "pnpm add @vx-oss/heroui-v2-code",
    bun: "bun add @vx-oss/heroui-v2-code"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Code} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Code} from "@vx-oss/heroui-v2-code";',
  }}
/>
