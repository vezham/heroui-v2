...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add accordion",
    npm: "npm install @vx-oss/heroui-v2-accordion",
    yarn: "yarn add @vx-oss/heroui-v2-accordion",
    pnpm: "pnpm add @vx-oss/heroui-v2-accordion",
    bun: "bun add @vx-oss/heroui-v2-accordion"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Accordion, AccordionItem} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Accordion, AccordionItem} from "@vx-oss/heroui-v2-accordion";',
  }}
/>
