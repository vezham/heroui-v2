...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add image",
    npm: "npm install @vx-oss/heroui-v2-image",
    yarn: "yarn add @vx-oss/heroui-v2-image",
    pnpm: "pnpm add @vx-oss/heroui-v2-image",
    bun: "bun add @vx-oss/heroui-v2-image"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Image} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Image} from "@vx-oss/heroui-v2-image";',
  }}
/>
