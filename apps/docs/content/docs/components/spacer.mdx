...
<PackageManagers
  ...
  commands={{
    ...
    npm: "npm install @vx-oss/heroui-v2-spacer",
    yarn: "yarn add @vx-oss/heroui-v2-spacer",
    pnpm: "pnpm add @vx-oss/heroui-v2-spacer",
    bun: "bun add @vx-oss/heroui-v2-spacer"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Spacer} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Spacer} from "@vx-oss/heroui-v2-spacer";',
  }}
/>
