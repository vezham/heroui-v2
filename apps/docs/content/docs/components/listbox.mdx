...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add listbox",
    npm: "npm install @vx-oss/heroui-v2-listbox",
    yarn: "yarn add @vx-oss/heroui-v2-listbox",
    pnpm: "pnpm add @vx-oss/heroui-v2-listbox",
    bun: "bun add @vx-oss/heroui-v2-listbox"
  }}
/>
