...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add date-picker",
    npm: "npm install @vx-oss/heroui-v2-date-picker",
    yarn: "yarn add @vx-oss/heroui-v2-date-picker",
    pnpm: "pnpm add @vx-oss/heroui-v2-date-picker",
    bun: "bun add @vx-oss/heroui-v2-date-picker",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {DateRangePicker} from "@vx-oss/heroui-v2-react";',
    individual: 'import {DateRangePicker} from "@vx-oss/heroui-v2-date-picker";',
  }}
/>
