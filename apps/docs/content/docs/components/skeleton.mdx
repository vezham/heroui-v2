...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add skeleton",
    npm: "npm install @vx-oss/heroui-v2-skeleton",
    yarn: "yarn add @vx-oss/heroui-v2-skeleton",
    pnpm: "pnpm add @vx-oss/heroui-v2-skeleton",
    bun: "bun add @vx-oss/heroui-v2-skeleton"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Skeleton} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Skeleton} from "@vx-oss/heroui-v2-skeleton";',
  }}
/>
