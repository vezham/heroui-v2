...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add progress",
    npm: "npm install @vx-oss/heroui-v2-progress",
    yarn: "yarn add @vx-oss/heroui-v2-progress",
    pnpm: "pnpm add @vx-oss/heroui-v2-progress",
    bun: "bun add @vx-oss/heroui-v2-progress"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {CircularProgress} from "@vx-oss/heroui-v2-react";',
    individual: 'import {CircularProgress} from "@vx-oss/heroui-v2-progress";',
  }}
/>
