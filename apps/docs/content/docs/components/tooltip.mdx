...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add tooltip",
    npm: "npm install @vx-oss/heroui-v2-tooltip",
    yarn: "yarn add @vx-oss/heroui-v2-tooltip",
    pnpm: "pnpm add @vx-oss/heroui-v2-tooltip",
    bun: "bun add @vx-oss/heroui-v2-tooltip"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Tooltip} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Tooltip} from "@vx-oss/heroui-v2-tooltip";',
  }}
/>

> For individual installation, please note that you should add `./node_modules/@vx-oss/heroui-v2-theme/dist/components/popover.js` to your `tailwind.config.js` file instead since tooltip reuses popover styles.
