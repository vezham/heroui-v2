...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add kbd",
    npm: "npm install @vx-oss/heroui-v2-kbd",
    yarn: "yarn add @vx-oss/heroui-v2-kbd",
    pnpm: "pnpm add @vx-oss/heroui-v2-kbd",
    bun: "bun add @vx-oss/heroui-v2-kbd"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Kbd} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Kbd} from "@vx-oss/heroui-v2-kbd";',
  }}
/>
