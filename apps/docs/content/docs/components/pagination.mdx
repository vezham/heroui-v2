...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add pagination",
    npm: "npm install @vx-oss/heroui-v2-pagination",
    yarn: "yarn add @vx-oss/heroui-v2-pagination",
    pnpm: "pnpm add @vx-oss/heroui-v2-pagination",
    bun: "bun add @vx-oss/heroui-v2-pagination"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Pagination, PaginationItem, PaginationCursor} from "@vx-oss/heroui-v2-react";',
    individual:
      'import {Pagination, PaginationItem, PaginationCursor} from "@vx-oss/heroui-v2-pagination";',
  }}
/>
