...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add radio",
    npm: "npm install @vx-oss/heroui-v2-radio",
    yarn: "yarn add @vx-oss/heroui-v2-radio",
    pnpm: "pnpm add @vx-oss/heroui-v2-radio",
    bun: "bun add @vx-oss/heroui-v2-radio"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {RadioGroup, Radio} from "@vx-oss/heroui-v2-react";',
    individual: 'import {RadioGroup, Radio} from "@vx-oss/heroui-v2-radio";',
  }}
/>
