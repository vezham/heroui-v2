...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add link",
    npm: "npm install @vx-oss/heroui-v2-link",
    yarn: "yarn add @vx-oss/heroui-v2-link",
    pnpm: "pnpm add @vx-oss/heroui-v2-link",
    bun: "bun add @vx-oss/heroui-v2-link"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Link} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Link} from "@vx-oss/heroui-v2-link";',
  }}
/>
