...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add user",
    npm: "npm install @vx-oss/heroui-v2-user",
    yarn: "yarn add @vx-oss/heroui-v2-user",
    pnpm: "pnpm add @vx-oss/heroui-v2-user",
    bun: "bun add @vx-oss/heroui-v2-user"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {User} from "@vx-oss/heroui-v2-react";',
    individual: 'import {User} from "@vx-oss/heroui-v2-user";',
  }}
/>
