...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add number-input",
    npm: "npm install @vx-oss/heroui-v2-number-input",
    yarn: "yarn add @vx-oss/heroui-v2-number-input",
    pnpm: "pnpm add @vx-oss/heroui-v2-number-input",
    bun: "bun add @vx-oss/heroui-v2-number-input"
  }}
/>
