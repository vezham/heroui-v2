...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add tabs",
    npm: "npm install @vx-oss/heroui-v2-tabs",
    yarn: "yarn add @vx-oss/heroui-v2-tabs",
    pnpm: "pnpm add @vx-oss/heroui-v2-tabs",
    bun: "bun add @vx-oss/heroui-v2-tabs"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Tabs, Tab} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Tabs, Tab} from "@vx-oss/heroui-v2-tabs";',
  }}
/>
