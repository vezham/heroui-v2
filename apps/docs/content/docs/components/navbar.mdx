...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add navbar",
    npm: "npm install @vx-oss/heroui-v2-navbar",
    yarn: "yarn add @vx-oss/heroui-v2-navbar",
    pnpm: "pnpm add @vx-oss/heroui-v2-navbar",
    bun: "bun add @vx-oss/heroui-v2-navbar"
  }}
/>
