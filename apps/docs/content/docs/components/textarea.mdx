...
<PackageManagers
  ...
  commands={{
    cli: "npx vezham-cli@latest add input",
    npm: "npm install @vx-oss/heroui-v2-input",
    yarn: "yarn add @vx-oss/heroui-v2-input",
    pnpm: "pnpm add @vx-oss/heroui-v2-input",
    bun: "bun add @vx-oss/heroui-v2-input",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Textarea} from "@vx-oss/heroui-v2-react";',
    individual: 'import {Textarea} from "@vx-oss/heroui-v2-input";',
  }}
/>
