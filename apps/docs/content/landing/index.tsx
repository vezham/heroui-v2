...
import {Code} from "@vx-oss/heroui-v2-react";
...
export default {
  ...
  themingCode: `const { heroui } = require("@vx-oss/heroui-v2-react");
...
`,
  darkModeExampleCode: `import {Card, CardBody, Button, Image, Progress, CardProps} from "@vx-oss/heroui-v2-react";
