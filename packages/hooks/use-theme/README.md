...
```sh
yarn add @vx-oss/heroui-v2-use-theme
# or
npm i @vx-oss/heroui-v2-use-theme
```
...
`tailwind.config.js` file. See [Create Theme](https://v2.heroui.com/docs/customization/create-theme) for more details.
